...
if [[ ! -d "${script_dir}/node_modules/@elastic/elasticsearch" ]]; then
  echo "JavaScript dependencies are not installed." >&2
  echo "Run 'npm ci' in c13/javascript before using this script." >&2
  exit 1
fi
